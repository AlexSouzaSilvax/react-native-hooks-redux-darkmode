    ...
    return(
        ...
        />
            <View style={{width: Dimensions.get('screen').width - 50, backgroundColor: '#aaa', alignItems: 'center', borderRadius: 4}}>
                <Text style={{fontSize: 25, fontWeight: 'bold', marginTop: 5}}>Tela 2</Text>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Tela1')} style={{width: Dimensions.get('screen').width - 50, height: 42, marginTop: 50, backgroundColor: '#ddd', alignItems: 'center', justifyContent: 'center', margin: 8 }}>
                    <Text style={{fontSize: 20}}>Tela 1</Text>
                </TouchableOpacity>
            </View>
